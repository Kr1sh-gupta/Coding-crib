...
// ADMISSION -> OVERVIEW 
export const admissionOverviewData = {
  overviewText: [
  ...
  // ADMISSION -> OVERVIEW -> College Details
  collegeDetails: [
    {
      name: "The Government PU college, Rajanakunte",
      courses: "Arts, Commerce, and Science",
      students: 388,
      faculty: 11,
      coursesOffered: "Science(PCMB/PCMC), Commerce(HEBA, CEBA), Arts(HEPS)",
    },
    {
      name: "The Government High School, Rajanakunte",
      gradeLevels: "9th and 10th",
      mediums: "Kannada and English",
      students: 197,
      faculty: 9,
    },
    {
      name: "The Government Primary School, Rajanakunte",
      gradeLevels: "Std 1 to 8",
      mediums: "Kannada (Std 1-5) and Kannada/English (6th-8th)",
      students: 357,
